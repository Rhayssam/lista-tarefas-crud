...
if(isset($_POST['usuario']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['usuario']) == 0){
        ...
        header("Location: index.php?msg=Preencha a sua senha!");
    } else {
        ...
        // Verifica se a quantidade de resultados é maior que 1
        ...
        if($qtd == 1){
            ...
            // Guardando as informações da sessão (id e nome do usuário)
        ...
        <div class="row">
            <div class="box-login col-lg-4 offset-lg-4">
                ...
                <form action="" method="POST">
                    ...
                    <a href="createac.php">Não possui uma conta?</a>
                </form>
            </div>
        </div>
    </div>
